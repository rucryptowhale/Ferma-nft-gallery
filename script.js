...
async function fetchNFTData() {
    try {
        ...
        const response = await fetch(`/api/nfts?collection=${CONFIG.COLLECTION_ADDRESS}&limit=${CONFIG.MAX_ITEMS}`);
...
// Получение лучшего URL изображения
